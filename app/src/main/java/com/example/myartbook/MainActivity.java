...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) { //i nereye tiklanacagini tutar
                Intent intent = new Intent(MainActivity.this,AddArtActivity.class);
                intent.putExtra("artId", idArray.get(i)); // putExtra ile bilgi yollariz ote tarafa yani AddArta'a
    ...
    @Override
    public boolean onCreateOptionsMenu(Menu menu) { // bu
